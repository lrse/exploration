...
public:
	...
	explicit vector#typeext#( const oclass &other ):gsldata(NULL) {copy(other);}
	~vector#typeext#(){free();}
...
//      This function adds the elements of vector b to the elements of vector a, a'_i = a_i + b_i. The two vectors must have the same length. 
	vector#typeext#& operator+=(const vector#typeext# &other) { gsl_vector#typeext#_add (gsldata, other.gsldata); return *this; }
...
//      This function subtracts the elements of vector b from the elements of vector a, a'_i = a_i - b_i. The two vectors must have the same length. 
	vector#typeext#& operator-=(const vector#typeext# &other) { gsl_vector#typeext#_sub (gsldata, other.gsldata); return *this; }
...
//      This function multiplies the elements of vector a by the elements of vector b, a'_i = a_i * b_i. The two vectors must have the same length. 
	vector#typeext#& operator*=(const vector#typeext# &other) { gsl_vector#typeext#_mul (gsldata, other.gsldata); return *this; }
...
//      This function divides the elements of vector a by the elements of vector b, a'_i = a_i / b_i. The two vectors must have the same length. 
	vector#typeext#& operator/=(const vector#typeext# &other) { gsl_vector#typeext#_div (gsldata, other.gsldata); return *this; }

//      This function multiplies the elements of vector a by the constant factor x, a'_i = x a_i. 
	vector#typeext#& operator*=(#type# x) { gsl_vector#typeext#_scale (gsldata, x); return *this; }
...
//      This function adds the constant value x to the elements of the vector a, a'_i = a_i + x. 
	vector#typeext#& operator+=(#type# x) { gsl_vector#typeext#_add_constant (gsldata,x); return *this; }

//  Function: int gsl_vector#typeext#_add_constant (gsl_vector#typeext# * a, const double x)
//      This function substracts the constant value x to the elements of the vector a, a'_i = a_i - x.
	vector#typeext#& operator-=(#type# x) { gsl_vector#typeext#_add_constant (gsldata, -x); return *this; }
